...
global.Items = {
	...
	DarkCreatorItem : {
		...
		Replaceble : ObDarkCreator,
		ReplacebleSprite : SpDarkCreator,
	},
	WorkbenchItem : {
		Name : "item_workbench",
		Weight : 4,
	...
	BlockWoodItem : {
		...
		Weight : 1,
		Item : ObBlockWoodItem,
		InvSprite : SpBlockWoodItem,
		Flags : [flags.pickup, flags.placeble],
		Replaceble : ObBlockWood,
		ReplacebleSprite : SpBlockWood,
	},
	BlockWoodDoorItem : {
		Name : "item_block_door",
		Weight : 1,
		Item : ObBlockWoodDoorItem,
		InvSprite : SpBlockWoodDoorItem,
		Flags : [flags.pickup, flags.placeble],
		Replaceble : ObBlockWoodDoor,
		ReplacebleSprite : SpBlockWoodDoor,
	},
	StoneAxe : {
		Name : "item_stone_axe",
		Weight : 1,
	...
	TestTube : {
		...
		Weight : 0.1,
		Item : ObTestTube,
		InvSprite : SpTestTube,
		Flags : [flags.pickup],
	},
	TestTubeWithMana : {
		Name : "item_test_tube_with_mana",
		Weight : 0.2,
		Item : ObTestTubeWithMana,
		InvSprite : SpTestTubeWithMana,
	...
	TestTubeWithHealth : {
		...
		Weight : 0.2,
		Item : ObTestTubeWithHealth,
		InvSprite : SpTestTubeWithHealth,
		Flags : [flags.pickup, flags.food],
	...
	TestTubeWithEssenceOfNight : {
		...
		Weight : 0.2,
		Item : ObTestTubeWithEssenceOfNight,
		InvSprite : SpTestTubeWithEssenceOfNight,
		Flags : [flags.pickup],
	},
	TestTubeWithEssenceOfDay : {
		Name : "item_test_tube_with_essence_of_day",
		Weight : 0.05,
		Item : ObTestTubeWithEssenceOfDay,
		InvSprite : SpTestTubeWithEssenceOfDay,
		Flags : [flags.pickup],
	},
	HearthFlowerSeed : {
	...
	EssenceOfNight : {
		...
		Weight : 0.5,
		Item : ObEssenceOfNight,
		InvSprite : SpEssenceOfNight,
		Flags : [flags.pickup],
	},
	EssenceOfDay : {
	...
	ManaRecoveryBracelet : {
		...
		Weight : 1,
		Item : ObManaRecoveryBracelet,
		InvSprite : SpManaRecoveryBracelet,
	...
	HealthRecoveryBracelet : {
		...
		Weight : 1,
		Item : ObHealthRecoveryBracelet,
		InvSprite : SpHealthRecoveryBracelet,
		Flags : [flags.pickup, flags.armor, flags.body, flags.recover],
	...
	RecoveryBracelet : {
		...
		Weight : 3,
		Item : ObRecoveryBracelet,
		InvSprite : SpRecoveryBracelet,
		Flags : [flags.pickup, flags.armor, flags.body, flags.recover],
